...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/d61bf5fd90bff2b5823a452c005015db.html";
...
var webviewIdentifier = 'template-webview.webview';
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  browserWindow.loadURL(__webpack_require__(/*! ../resources/index.html */ "./resources/index.html")); // only show the window when the page has loaded to avoid a white flash

  browserWindow.once('ready-to-show', function () {
    browserWindow.show();
  });
  browserWindow.webContents.on('colorBlindness', function (layerid) {
    ...
    if (selectedLayer) {
      var image = sketch["export"](selectedLayer, {
        formats: 'png',
        output: false
      });
      browserWindow.webContents.executeJavaScript("getPreviewImage('".concat("data:image/png;base64,".concat(image.toString('base64')), "', '", selectedLayer.id, "')"));
    }
  });
  browserWindow.webContents.on('queryPreviewImage', function (s) {
    console.log('queryPreviewImage');
    sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message('queryPreviewImage');
  });
